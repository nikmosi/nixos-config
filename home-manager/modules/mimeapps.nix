{
  ...
  xdg.mimeApps.defaultApplications = {
    ...
    "x-scheme-handler/tg" = "userapp-AyuGram Desktop-QQTK02.desktop";
    "x-scheme-handler/tonsite" = "userapp-AyuGram Desktop-KYFK02.desktop";
  };

  xdg.mimeApps.associations.added = {
    "application/pdf" = "org.pwmt.zathura.desktop;zathura.desktop";
    "inode/directory" = "thunar.desktop";
    "x-scheme-handler/tg" = "userapp-AyuGram Desktop-INCJK2.desktop;userapp-AyuGram Desktop-QQTK02.desktop";
    "x-scheme-handler/tonsite" = "userapp-AyuGram Desktop-9PA1S2.desktop;userapp-AyuGram Desktop-KYFK02.desktop";
  };
}
